...
class NeuroClassifier(NeuroBase):
    """Feed Forward Neural Network for Classification whose weights are evolved.

    NeuroClassifier evolves the weights of a static feed forward neural network
    ...
    multi_label : bool, default = False
               If True, the error function will be adapted for multiple labels. If False, the
               error function will be adapted for only classes.
    ...
    def predict(self, data):
        """Predicts the class or label outcome of the data using the best model
